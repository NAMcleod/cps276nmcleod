...
function init(){
    ...
    if(isset($_POST['delete']))
    {
        if(isset($_POST['chkbx']))
        {
            ...
            foreach($_POST['chkbx'] as $id)
            {
                ...
                $sql = "DELETE FROM tableSTAFF WHERE id=:id";
    ...
    {
        $output = "<h1>Delete Contact(s)</h1><form method='post' action='index.php?page=deleteContacts'>";
